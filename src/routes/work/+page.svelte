...
<div class="max-w-3xl mx-auto px-6">
	<PageHeader
		title="Work"
		description="Constraints, contribution, and outcomes across senior engineering and technical-lead engagements in product and platform delivery."
	/>
	...
	<dl class="work-stats">
		...
		<div class="work-stat-row">
			...
			<dd class="work-stat-val">15+ embedded engagements</dd>
		</div>
	</dl>
	...
	<section class="earlier-work" aria-labelledby="earlier-heading">
		<h2 id="earlier-heading" class="earlier-heading">
			Additional client engagements and earlier employment
		</h2>
